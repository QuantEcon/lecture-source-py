...
The Markov transition matrix is :math:`(1/3) I` where :math:`I` is a :math:`3 \times 3` identity matrix, so the :math:`s_t` process is i.i.d.
...
But because we are studying an i.i.d. case, :math:`\pi` has identical
