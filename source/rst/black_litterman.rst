...
-  For any given :math:`h`, the autocorrelation converges to zero as we increase the
distance -- :math:`n`-- between the observations. This represents the
"weak dependence" of the :math:`X` process

-  Moreover, for a fixed lag length, :math:`n`, the dependence vanishes as the sampling frequency
