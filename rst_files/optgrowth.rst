...
.. include:: /_static/includes/lecture_howto_{{ file_extension }}.raw

.. highlight:: {{ programming_language }}
...
.. only:: html
    ...
    One good choice from both respects is continuous piecewise linear interpolation (see :download:`this paper <{{ pdfs_dir }}/3ndp.pdf>` for further discussion)

.. only:: latex

    One good choice from both respects is continuous piecewise linear interpolation (see `this paper <{{ download_web_dir }}/3ndp.pdf>`__ for further discussion)
...
.. figure:: {{ figures_dir }}/solution_og_ex2.png
   :scale: 100%
