...
{% if nb_lang == 'py' and not indexPage %}
						...
						<ul class="badges">
							...
							{% if download_nb == True %}
								<li><a href="/{{nb_lang}}/_downloads/ipynb/py/{{nb_filename_with_path}}.ipynb"><img src="/_static/img/jupyter-notebook-download-blue.svg" id="notebook_download_badge"></a></li>
...
{% elif nb_lang == 'jl' and not indexPage %}
						...
						<ul class="badges">
							{% if download_nb == True %}
								<li><a href="/{{nb_lang}}/_downloads/ipynb/jl/{{nb_filename_with_path}}.ipynb"><img src="/_static/img/jupyter-notebook-download-blue.svg" id="notebook_download_badge"></a></li>
